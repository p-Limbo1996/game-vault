      ...
      <Routes>
        <Route element={<VaultLayout />}>
          ...
          <Route
            path="/categories"
            element={
              <VaultPlaceholder title="Categories" eyebrow="ARSENAL INDEX" />
            }
          />
          <Route
            path="/downloads"
            element={
              <VaultPlaceholder title="Downloads" eyebrow="VAULT DELIVERY" />
            }
          />
          <Route
            path="/messages"
            element={
              <VaultPlaceholder title="Messages" eyebrow="SECURE COMMS" />
            }
          />
          <Route
            path="/notifications"
            element={
              <VaultPlaceholder title="Notifications" eyebrow="SYSTEM ALERTS" />
            }
          />
